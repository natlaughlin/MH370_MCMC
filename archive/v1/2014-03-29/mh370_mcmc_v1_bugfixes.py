...
fn = os.path.join(os.path.dirname(__file__), 'plot_ln127.svg')
plt.savefig(fn)
...
fn = os.path.join(os.path.dirname(__file__), 'plot_ln130.svg')
plt.savefig(fn)
...
fn = os.path.join(os.path.dirname(__file__), 'plot_ln160.svg')
plt.savefig(fn)
...
fn = os.path.join(os.path.dirname(__file__), 'plot_ln165.svg')
plt.savefig(fn)
...
fn = os.path.join(os.path.dirname(__file__), 'plot_ln166.svg')
plt.savefig(fn)
...
fn = os.path.join(os.path.dirname(__file__), 'plot_ln167.svg')
plt.savefig(fn)
...
def five_hop_model_final(heading_init,lon_init,lat_init,km_hop,std_dev,ping_percent_err):   
    ...
    #bug fix -> need to switch 1 & 0. Ironically, my make_circle and make_vector bugs almost offset each other...
...
fn = os.path.join(os.path.dirname(__file__), 'plot_ln150.svg')
plt.savefig(fn)
...
fn = os.path.join(os.path.dirname(__file__), 'plot_ln151.svg')
plt.savefig(fn)
...
fn = os.path.join(os.path.dirname(__file__), 'plot_ln154.svg')
plt.savefig(fn)
...
fn = os.path.join(os.path.dirname(__file__), 'plot_ln155.svg')
plt.savefig(fn)
...
fn = os.path.join(os.path.dirname(__file__), 'plot_ln158.svg')
plt.savefig(fn)
...
fn = os.path.join(os.path.dirname(__file__), 'plot_ln159.svg')
plt.savefig(fn)
